import{D as e,E as t,F as n}from"./app-BGx71MgL.js";import{t as r}from"./plugin-vue_export-helper-BDNMzG2s.js";var i=JSON.parse(`{"path":"/reference/%E5%AE%9E%E7%94%A8AI%E8%AE%B0%E5%BD%95%E6%9C%AC/%E8%AF%AD%E8%A8%80%E6%A8%A1%E5%9E%8B/%E9%A2%84%E6%B5%8B%E6%80%A7%E8%BE%93%E5%87%BA.html","title":"预测性输出","lang":"zh-CN","frontmatter":{"description":"预测性输出 在调用 API 的时候，附上一个“预测输出”， AI 就会基于这个进行修改，而不是从头生成 原文：预测性输出 使用 Predicted Outputs 的时候，也不会特别复杂，参数的最后 prediction 字段就行了，比如下面这个 然后就会获得这个，返回速度相当快： 在这个修改版本中： 将所有用到“用户名”的地方替换为“用户ID”。 在...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"预测性输出\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2025-01-14T01:42:25.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"nihilityer\\",\\"url\\":\\"https://docs.llmtest.top\\"}]}"],["meta",{"property":"og:url","content":"https://docs.llmtest.top/reference/%E5%AE%9E%E7%94%A8AI%E8%AE%B0%E5%BD%95%E6%9C%AC/%E8%AF%AD%E8%A8%80%E6%A8%A1%E5%9E%8B/%E9%A2%84%E6%B5%8B%E6%80%A7%E8%BE%93%E5%87%BA.html"}],["meta",{"property":"og:site_name","content":"AI游戏开发参考"}],["meta",{"property":"og:title","content":"预测性输出"}],["meta",{"property":"og:description","content":"预测性输出 在调用 API 的时候，附上一个“预测输出”， AI 就会基于这个进行修改，而不是从头生成 原文：预测性输出 使用 Predicted Outputs 的时候，也不会特别复杂，参数的最后 prediction 字段就行了，比如下面这个 然后就会获得这个，返回速度相当快： 在这个修改版本中： 将所有用到“用户名”的地方替换为“用户ID”。 在..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2025-01-14T01:42:25.000Z"}],["meta",{"property":"article:modified_time","content":"2025-01-14T01:42:25.000Z"}]]},"git":{"createdTime":1734247850000,"updatedTime":1736818945000,"contributors":[{"name":"nihilityer","username":"nihilityer","email":"nihilityer@mail.nihilityer.top","commits":1,"url":"https://github.com/nihilityer"},{"name":"bot","username":"bot","email":"bot@mail.nihilityer.top","commits":1,"url":"https://github.com/bot"}]},"readingTime":{"minutes":3.04,"words":913},"filePathRelative":"reference/实用AI记录本/语言模型/预测性输出.md","autoDesc":true}`),a={name:`预测性输出.md`};function o(r,i,a,o,s,c){return n(),t(`div`,null,[...i[0]||=[e(`<h1 id="预测性输出" tabindex="-1"><a class="header-anchor" href="#预测性输出"><span>预测性输出</span></a></h1><p><strong>在调用 API 的时候，附上一个“预测输出”， AI 就会基于这个进行修改，而不是从头生成</strong></p><p>原文：<a href="https://mp.weixin.qq.com/s?__biz=MzkzNDQxOTU2MQ==&amp;mid=2247493590&amp;idx=1&amp;sn=69a5f845766c85cac20f67e40a6095b4&amp;chksm=c385793fef7deedd5f9b78d2c9b9e59aa3117b7a9eee3bfa795e5f0e943b11418becf4a88ffc&amp;mpshare=1&amp;scene=23&amp;srcid=1208XVBetHCFyMpfrcsiEyIj&amp;sharer_shareinfo=0a65793aa33979966a814c1b412c08cd&amp;sharer_shareinfo_first=b32152277c1293c87297789704d2b143#rd" target="_blank" rel="noopener noreferrer">预测性输出</a></p><p>使用 Predicted Outputs 的时候，也不会特别复杂，参数的最后\xA0prediction\xA0字段就行了，比如下面这个</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>from openai import OpenAI</span></span>
...
<span class="line"><span>print(completion.usage)</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后就会获得这个，返回速度相当快：</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>为了将代码中所有用到的“用户名”改为“用户ID”并添加一个“优惠信息”字段，你需要修改类定义和相关的方法。下面是相应的修改：</span></span>
<span class="line"><span></span></span>
